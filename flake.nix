    ...
    in
      ...
      // flake-utils.lib.eachDefaultSystem (system:
        ...
        in {
          ...
          # Naiserator Application (application.nais.io) from app module
          packages.manifests-nais-application = let
            built = nlib.buildNaiseratorApplication {
              app = {
                name = "myapplication";
                namespace = "myteam";
          ...
          checks = let
            # Discover manifest packages dynamically (anything in packages starting with "manifests")
            manifestNames = lib.filter (n: lib.hasPrefix "manifests" n) (builtins.attrNames self.packages.${system});
